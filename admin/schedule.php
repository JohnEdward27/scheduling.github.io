		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<button class="btn btn-primary btn-block btn-sm col-sm-2 float-right" type="button" id="print" >Print</button>
				<br /><br />
...
<script>
	...
	$('#print').click(function(){
		_conf("Are you sure to print this schedule?","print",[$(this).attr('data-id')])
	})
